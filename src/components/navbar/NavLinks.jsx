...
const NavLink = () => {
  ...
  return (
    <div className="">
      <ul className="hidden lg:flex justify-center w-full gap-x-10 text-gray-700 uppercase font-semibold px-5 py-1">
        {links.map((link) => {
          ...
          return (
            <li key={id} className="group">
              <a
                href={href}
                className="capitalize text-2xl tracking-wider hover:text-cyan-600 duration-300">
                {text}
              </a>

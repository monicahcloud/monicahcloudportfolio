...
const Hero = () => {
  return (
    <div
      id="home"
      className="w-full h-auto md:h-screen md:text-center items-end pt-60 ">
      <div className=" grid md:grid-cols-2 items-center gap-8 mx-auto justify-between relative">
